...
{
	ColonyHub: BuildableDefn;
	Factory: BuildableDefn;
	Laboratory: BuildableDefn;
	Plantation: BuildableDefn;
	...
	constructor()
	{
		...
		this.ColonyHub = new BuildableDefn
		(
			"Colony Hub",
			true, // isItem
			terrainNamesSurface,
		...
		this.Factory = new BuildableDefn
		(
			"Factory",
			false, // isItem
			terrainNamesSurface,
		...
		this.Laboratory = new BuildableDefn
		(
			"Laboratory",
			false, // isItem
			terrainNamesSurface,
		...
		this.Plantation = new BuildableDefn
		(
			"Plantation",
			false, // isItem
			terrainNamesSurface,
		...
		this.ShipDriveBasic = new BuildableDefn
		(
			"Ship Drive, Basic",
			true, // isItem
			terrainNamesOrbit,
		...
		this.ShipGeneratorBasic = new BuildableDefn
		(
		...
		this.ShipShieldBasic = new BuildableDefn
		(
			"Ship Shield, Basic",
			true, // isItem
			terrainNamesOrbit,
		...
		this.ShipWeaponBasic = new BuildableDefn
		(
			"Ship Weapon, Basic",
			true, // isItem
			terrainNamesOrbit,
