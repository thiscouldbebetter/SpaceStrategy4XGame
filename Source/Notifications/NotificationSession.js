...
class NotificationSession {
    ...
    toControl(universe) {
        ...
        [
            ...
            ControlButton.from8("buttonGoTo", Coords.fromXY(margin, margin * 2 + controlHeight * 7), // pos
            ...
            ControlButton.from8("buttonDismissAll", Coords.fromXY(margin * 3 + buttonWidth * 2, margin * 2 + controlHeight * 7), // pos
            Coords.fromXY(buttonWidth, controlHeight), // size
            ...
            ControlButton.from8("buttonBack", Coords.fromXY(margin, containerSize.y - margin - controlHeight), // pos
            Coords.fromXY(columnWidth, controlHeight), // size
